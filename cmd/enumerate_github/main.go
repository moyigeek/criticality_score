...
import (
	...
	"github.com/HUSTSecLab/criticality_score/cmd/enumerate_github/githubsearch"
	"github.com/HUSTSecLab/criticality_score/cmd/enumerate_github/marker"
	"github.com/HUSTSecLab/criticality_score/cmd/enumerate_github/repowriter"
	"github.com/HUSTSecLab/criticality_score/internal/envflag"
	"github.com/HUSTSecLab/criticality_score/internal/githubapi"
	log "github.com/HUSTSecLab/criticality_score/internal/log"
	"github.com/HUSTSecLab/criticality_score/internal/outfile"
	"github.com/HUSTSecLab/criticality_score/internal/workerpool"
)
...
var (
	...
	dbConfigFlag        = flag.String("config", "", "path to the database configuration file.")
