/*
 * @Date: 2024-08-31 03:34:08
 * @LastEditTime: 2024-09-27 22:02:59
 * @Description:
 */
package workerpool
...
func init() {
	defaultPool = NewPool("workerpool.DefaultPool", math.MaxInt32, NewConfig())
}

// Go is an alternative to the go keyword, which is able to recover panic.
//
//	workerpool.Go(func(arg interface{}){
//	    ...
//	}(nil))
func Go(f func()) {
